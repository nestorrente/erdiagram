import {
	...
	fullDatabaseModel
} from '#/erdiagram/converter/database/code-converter/common/test-database-models';
...
function getTestExpectedResult(expectedResultFile: string, sqlDialectId: string): string {
	return require(`!!raw-loader!#/erdiagram/converter/database/code-converter/sql/DatabaseModelToSqlCodeConverter_func_spec_expected_results/${sqlDialectId}/${expectedResultFile}`);
}
