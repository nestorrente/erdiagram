CREATE TABLE "Modifiers_Table" (
    "the_id_of_modifiers_table" CUSTOM_IDENTITY_TYPE NOT NULL IDENTITY(1, 1),
...
CREATE TABLE "Types_Table" (
    "the_id_of_types_table" CUSTOM_IDENTITY_TYPE NOT NULL IDENTITY(1, 1),
...
CREATE TABLE "References_Table" (
    "the_id_of_references_table" CUSTOM_IDENTITY_TYPE NOT NULL IDENTITY(1, 1),
